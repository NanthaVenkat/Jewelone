...
const testimonials = [
    {
        id: 1,
        name: "ARAVIND GANESAN(COIMBATORE)",
        company: "Grower.io",
    ...
    {
        id: 3,
        name: "REVATHI RAJENDHRAN(TRICHY)",
        company: "Grower.io",
    ...
    {
        id: 7,
        name: "NATHIYA SENTHILKUMAR(MADURAI)",
        company: "Grower.io",
    ...
    {
        id: 10,
        name: "KARUNAKARAN KADHIRVELU(TRICHY)",
        company: "Grower.io",
    ...
    {
        id: 11,
        name: "PRABHAVATHY RAMACHANDRAN(HOSUR)",
        company: "Grower.io",
    ...
    {
        id: 14,
        name: "RAJESHWARI VENKATESHAN(SALEM)",
        company: "Grower.io",
                                    ...
                                    <div key={item.id} class="testimonials-wrr tw:flex tw:flex-col tw:p-8 tw:rounded-sm tw:bg-[#F2EDE4]">
                                        ...
                                        <div class="tw:flex tw:items-start tw:gap-3 tw:mt-auto">
                                            ...
                                            <div>
                                                ...
                                                <p className="tw:text-[#303030]">{item.company}</p>
                                            </div>
                                        </div>
                                    </div>
                                ))}
