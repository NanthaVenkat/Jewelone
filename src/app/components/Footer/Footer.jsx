...
const Footer = () => {
  ...
  return (
    <footer className="tw:bg-[#FBFBFB]">
      <div className="tw:py-10 tw:px-4 tw:md:px-10 tw:lg:px-16">
        <div className="tw:grid tw:gap-10 tw:grid-cols-1 tw:lg:grid-cols-[40%_1fr]">
          <div className="tw:max-w-sm tw:max-lg:text-center tw:max-lg:mx-auto tw:space-y-3">
            <Image
              className="tw:max-lg:mx-auto tw:h-16"
              src="/images/logo.svg"
              width={160}
              height={76}
              alt="logo"
          ...
          <div>
            <div className="tw:grid tw:grid-cols-1 tw:md:grid-cols-[auto_auto_auto] tw:xl:grid-cols-3 tw:gap-3 tw:md:gap-6 tw:max-md:divide-y tw:max-md:divide-[#D4D4D4]">
              <FooterAccordion title="Information">
                <div className="tw:flex tw:flex-col tw:gap-2">
                  {/* <Link
                    href="#"
                    className="tw:!no-underline tw:!text-[#18181B] tw:text-base"
                  >
                    Our Story
                  </Link> */}
                  <Link
              ...
              <div>
                <div className="tw:text-lg tw:uppercase tw:max-md:text-center tw:md:text-start copperplate-font tw:font-semibold tw:text-black">
                  Swarna Sakthi App
                </div>

                <div className="tw:mt-3 tw:flex tw:justify-center tw:md:justify-start tw:flex-wrap tw:gap-2">
                  <div>
                    <a
                      target="__blank"
            ...
            <hr className="tw:text-[#D4D4D4] tw:my-4" />

            <div className="tw:flex tw:flex-col tw:justify-center tw:lg:flex-row tw:lg:justify-between tw:gap-4 tw:items-center">
